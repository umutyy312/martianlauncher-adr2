...
package com.foxstudio.martianlauncher.game.launch
...
import com.foxstudio.martianlauncher.BuildConfig
import com.foxstudio.martianlauncher.R
import com.foxstudio.martianlauncher.ZLApplication
import com.foxstudio.martianlauncher.bridge.LoggerBridge.append
import com.foxstudio.martianlauncher.bridge.LoggerBridge.appendTitle
import com.foxstudio.martianlauncher.bridge.ZLBridge
import com.foxstudio.martianlauncher.context.readAssetFile
import com.foxstudio.martianlauncher.game.account.Account
import com.foxstudio.martianlauncher.game.account.AccountType
import com.foxstudio.martianlauncher.game.account.offline.OfflineYggdrasilServer
import com.foxstudio.martianlauncher.game.addons.modloader.ModLoader
import com.foxstudio.martianlauncher.game.download.game.parseLibraryComponents
import com.foxstudio.martianlauncher.game.multirt.Runtime
import com.foxstudio.martianlauncher.game.multirt.RuntimesManager
...
import com.foxstudio.martianlauncher.game.plugin.renderer.RendererPluginManager
import com.foxstudio.martianlauncher.game.renderer.Renderers
import com.foxstudio.martianlauncher.game.support.touch_controller.ControllerProxy
import com.foxstudio.martianlauncher.game.version.installed.Version
import com.foxstudio.martianlauncher.game.version.installed.VersionInfoParser
import com.foxstudio.martianlauncher.game.version.installed.VersionsManager
import com.foxstudio.martianlauncher.game.versioninfo.models.GameManifest
import com.foxstudio.martianlauncher.path.LibPath
import com.foxstudio.martianlauncher.path.PathManager
import com.foxstudio.martianlauncher.setting.AllSettings
import com.foxstudio.martianlauncher.utils.GSON
import com.foxstudio.martianlauncher.utils.device.Architecture
import com.foxstudio.martianlauncher.utils.file.child
import com.foxstudio.martianlauncher.utils.file.ensureDirectorySilently
import com.foxstudio.martianlauncher.utils.logging.Logger
import com.foxstudio.martianlauncher.utils.string.isBiggerTo
import com.foxstudio.martianlauncher.utils.string.isEqualTo
...
class GameLauncher(
    ...
    override fun initEnv(screenSize: IntSize): MutableMap<String, String> {
        ...
        envMap["MARTIAN_VERSION_CODE"] = BuildConfig.VERSION_CODE.toString()
        return envMap
    }
