...
import com.foxstudio.martianlauncher.game.plugin.ApkPlugin
import com.foxstudio.martianlauncher.game.plugin.PluginLoader
import com.foxstudio.martianlauncher.game.plugin.appCacheIcon
import com.foxstudio.martianlauncher.library.LibraryInfo
import com.foxstudio.martianlauncher.library.libraryData
import com.foxstudio.martianlauncher.path.URL_COMMUNITY
import com.foxstudio.martianlauncher.path.URL_MCMOD
import com.foxstudio.martianlauncher.path.URL_PROJECT
import com.foxstudio.martianlauncher.path.URL_WEBLATE
import com.foxstudio.martianlauncher.ui.base.BaseScreen
import com.foxstudio.martianlauncher.ui.components.AnimatedLazyColumn
...
import com.foxstudio.martianlauncher.ui.theme.itemColor
import com.foxstudio.martianlauncher.ui.theme.onItemColor
            ...
            animatedItem(scope) { yOffset ->
                ChunkLayout(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        LinkIconItem(
                            icon = painterResource(R.drawable.img_avatar_foxstudio),
                ...
                ChunkLayout(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        LinkIconItem(
                            ...
                            text = stringResource(R.string.about_acknowledgements_zl2_text, BuildKeys.LAUNCHER_SHORT_NAME),
                            openLicense = { openLicense(R.raw.zl2_license) },
